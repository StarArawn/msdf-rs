...
impl EdgeSegment {
    ...
    pub fn new_quadratic(p0: Vector2, p1: Vector2, p2: Vector2, color: EdgeColor) -> Self {
        Self::QuadraticSegment { p0, p1, p2, color }
    }

    pub fn new_cubic(p0: Vector2, p1: Vector2, p2: Vector2, p3: Vector2, color: EdgeColor) -> Self {
        Self::CubicSegment {
            p0,
            p1,
            p2,
